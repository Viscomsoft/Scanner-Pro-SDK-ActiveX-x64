...
, "HatchStyleSolidDiamond "});
        ...
        private void rotate180Button_Click(object sender, EventArgs e)
        {
           ...
           // this.axScanner1.HideProgressBar = true;
            
            //this.axScanner1.SelectImageSourceByIndex(1);
            this.axScanner1.SelectImageSourceByIndex((short)imageSourceComboBox.SelectedIndex);
            


            //this.axScanner1.SetCaptureArea(0, 0, 1.0, 1.0);
        ...
        {
            if (captureAreaCheckBox.Checked)
            {

                captureLeft.Enabled = false;
                captureTop.Enabled = false;
                captureWidth.Enabled = false;
                captureHeight.Enabled = false;

           
            }
            else
            {
                captureLeft.Enabled = true;
                captureTop.Enabled = true;
                captureWidth.Enabled = true;
                captureHeight.Enabled = true;
            }
        ...
        private void axScanner1_Connected32bitTWAINBridge(object sender, EventArgs e)
        {
            ...
            if (imageSourceComboBox.Items.Count >0)
            imageSourceComboBox.SelectedIndex = 0;

        }

        private void btnConnect32BitBridge_Click(object sender, EventArgs e)
        {
            axScanner1.Connect32bitTWAINBridge();

        }

        private void btnDisconnect32BitBridge_Click(object sender, EventArgs e)
        {
            axScanner1.Disconnect32bitTWAINBridge();
            btnDisconnect32BitBridge.Enabled = false;
            scanButton.Enabled = false;

            btnConnect32BitBridge.Enabled = true;
